...
from loader.ace_loader3d import DataLoader3D
...
def train(Basic_Args):
    ...
    ###=========================== model maker =======================###
    model = ACE_UNet(num_classes=2, act='leakyrelu', pool_op_kernel_sizes=None, conv_kernel_sizes=None, args=Basic_Args)
    model = model.cuda()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--task_name', type=str, default='ace')
    ...
    parser.add_argument('--patch_size', default=[32, 64, 64])
